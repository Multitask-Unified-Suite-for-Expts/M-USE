...
public class EffortControl_TrialLevel : ControlLevel
{
    // game object variables
    public GameObject initButton;
    public GameObject fb;
    public GameObject goCue;
    public GameObject stimLeft;
    public GameObject stimRight;
    private GameObject trialStim;
    public GameObject clickMarker;
    public GameObject balloonContainerLeft;
    public GameObject balloonContainerRight;
    public GameObject balloonOutline;
    public GameObject prize;
    public GameObject rewardContainerLeft;
    public GameObject rewardContainerRight;
    ...
    public override void DefineControlLevel() {
            ...
            if (InputBroker.GetMouseButtonDown(0)) {
                ...
                if (Physics.Raycast(mouseRay, out hit)) {
                    if (hit.transform.name == "StartButton") {
                        Debug.Log("Start trial" + trialCount);
                        response = 0;
                    }
                }
            }
        ...
        stimOn.AddInitializationMethod(() => {
            ...
            trialStim = null;
            createBalloons(numOfClicksLeft, scaleUpAmountLeft, clickPerOutline, stimLeft.transform.position, balloonContainerLeft);
            createBalloons(numOfClicksRight, scaleUpAmountRight, clickPerOutline, stimRight.transform.position, balloonContainerRight);
