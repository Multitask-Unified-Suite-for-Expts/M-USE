...
public class HotKeyPanel : ExperimenterDisplayPanel
{
    ...
    public class HotKeyList
    {
        ...
        private ControlLevel_Session SessionLevel;
        ...
        public List<HotKey> DefaultHotKeyList()
        {
            ...
            HotKey quitGame = new HotKey
            {
                ...
                hotKeyAction = () =>
                {
                    TaskLevel.Terminated = true;
                    SessionLevel.TasksFinished = true;
                    // #if UNITY_EDITOR
                    //                     {
            ...
            HotKey pauseGame = new HotKey
            {
                ...
                hotKeyAction = () =>
                {
                    TaskLevel.Paused = TaskLevel.Paused == true ? TaskLevel.Paused = false : TaskLevel.Paused = true;
                }
            };
