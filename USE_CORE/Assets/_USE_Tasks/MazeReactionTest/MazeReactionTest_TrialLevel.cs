...
public class MazeReactionTest_TrialLevel : ControlLevel_Trial_Template
{
    ...
    public override void DefineControlLevel()
    {
        ...
        SetupTrial.AddInitializationMethod(() =>
        {
            ...
            if(StartButton == null)
            {
                StartButton = SessionValues.USE_StartButton.CreateStartButton(MRT_CanvasGO.GetComponent<Canvas>(), StartButtonPosition, StartButtonScale);
        ...
        ITI.AddInitializationMethod(() =>
        {
            ...
            if (NeutralITI)
            {
                ...
                CurrentTaskLevel.SetSkyBox(GetContextNestedFilePath(ContextExternalFilePath, "itiImage"), Camera.main.gameObject.GetComponent<Skybox>());
            }
        });
