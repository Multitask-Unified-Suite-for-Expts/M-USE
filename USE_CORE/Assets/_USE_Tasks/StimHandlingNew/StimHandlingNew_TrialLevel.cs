...
public class StimHandlingNew_TrialLevel : ControlLevel_Trial_Template
{
    public StimHandlingNew_TrialDef CurrentTrialDef => GetCurrentTrialDef<StimHandlingNew_TrialDef>();
