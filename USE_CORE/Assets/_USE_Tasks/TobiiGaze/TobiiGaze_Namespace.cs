...
{
    public class TobiiGaze_TaskDef : TaskDef
    {
    ...
    public class TobiiGaze_BlockDef : BlockDef
    {
    ...
    public class TobiiGaze_TrialDef : TrialDef
    {
        public int TrialID;
    ...
    public class TobiiGaze_StimDef : StimDef
    {
